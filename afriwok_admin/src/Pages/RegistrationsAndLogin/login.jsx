...
//               <p className="font-sans">Email Address <span className='text-blue-700 font-sans font-bold'>*</span></p>              
...
//               <p className="pt-2 font-sans">Password <span className='text-blue-700 font-sans font-bold'>*</span></p>
//               <div className="relative">
//                 <input
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://dummyapi.example/login', {
        email,
        password,
      });
      ...
      // If necessary, store tokens or other data in localStorage or context
