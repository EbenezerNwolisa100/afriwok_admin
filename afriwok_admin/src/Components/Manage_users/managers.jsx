...
import { MoreHorizontal, Download, Filter, Calendar, ChevronLeft, ChevronRight, Search, X, ChevronDown, Eye } from 'lucide-react'
            ...
            <tbody className="divide-y divide-gray-200">
              {adminUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 rounded-full text-xs font-sans ${getStatusClass(user.status)}`}>
                      {user.status}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <tbody className="divide-y divide-gray-200">
              {roles.map((role, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 rounded-full text-xs font-sans ${getStatusClass(role.status)}`}>
                      {role.status}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="p-4 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              >
                <option className='font-sans' value="+234">+234</option>
                <option className='font-sans' value="+1">+1</option>
                <option className='font-sans' value="+44">+44</option>
              </select>
              <input
                type="tel"
                required
