...
//         type="button"
//         className={`
//           lg:hidden fixed right-20 z-50 top-5 text-gray-600 hover:text-gray-900 focus:outline-none
...
//       <aside
//         className={`
//         fixed top-0 left-0 z-50 h-full w-60 bg-[#F9F9F9] font-sans
  ...
  return (
    <>
      <button
        type="button"
        className={`
          lg:hidden fixed z-50 top-5 text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200
          ${isMobileMenuOpen ? 'right-4' : 'left-4'}
        `}
        onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
