...
const CustomerDetails = () => {
  ...
  const customerData = {
    ...
    PayoutDetails: {
      serviceProvider: {
        ...
        accountnumber: "2210025581",
        accountname: "TechPro Solutions",
      },
    },
  };
  ...
  const logData = [
    ...
    },
    {
      date: "2024/04/09 00:12:06",
      description:
        "You initiated a work order deposit of N200,000.00 to escrow wallet",
    },
  ];
          ...
          <div className="">
            ...
            <div className=" bg-white p-6">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {Object.entries(customerData.personalInfo).map(
                  ([key, value]) => (
                    <div key={key}>
            ...
            {activeView === "service-provider" && (
              <div className="bg-white p-6 border-t border-gray-200">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {Object.entries(
                    customerData.PayoutDetails.serviceProvider
                  ).map(([key, value]) => (
                    <div key={key}>
                      <p className="text-sm font-sans text-gray-500">
                        {key.replace(/([A-Z])/g, " $1").trim()}
  ...
  return (
    <>
      <div>
        <button className="rounded-lg border border-gray-500 items-center gap-1 flex font-base text-lg py-1 px-3 bg-white">
            ...
            <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="items-center flex flex-col justify-center">
                  ...
                  <p className="font-sans">Update Info</p>
                </div>
              </div>
              <div className="">
                <div className="flex border p-2 rounded gap-1">
                  <button
                    onClick={() => setActiveView("client")}
                    className={`rounded-lg px-4 py-2 font-sans text-sm font-medium ${
                      activeView === "client"
                        ? "bg-gray-200 text-black font-sans border border-gray-300"
                        : "text-gray-600 font-sans hover:bg-gray-200"
                    }`}
                  >
                    Client
                    <p className="text-xs font-sans text-gray-500">
                      {activeView === "client" ? "Active" : "Inactive"}
                    </p>
                  </button>
                  <button
                    ...
                    className={`rounded-lg px-4 py-2 text-sm font-medium font-sans ${
                      activeView === "service-provider"
                        ? "bg-gray-200 text-black border font-sans"
